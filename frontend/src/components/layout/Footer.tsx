...
const Footer = () => {
  return (
    <footer className="relative w-full bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 text-white overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20">
        ...
        <div className="absolute top-1/2 left-1/3 w-24 h-24 bg-cyan-500/30 rounded-full blur-2xl animate-pulse delay-500"></div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div className="md:col-span-2">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3 text-blue-200 hover:text-white transition-colors group cursor-pointer hover:translate-x-1 transform duration-200">
                  <div className="w-10 h-10 bg-cyan-600/20 rounded-lg flex items-center justify-center group-hover:bg-cyan-600/40 transition-colors">
                    <MapPin size={18} />
                  </div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={service} className="hover:translate-x-1 transform duration-200">
                    <span className="text-blue-200 hover:text-white transition-colors cursor-pointer flex items-center gap-2 group">
                      <div className="w-1.5 h-1.5 bg-blue-400 rounded-full group-hover:bg-white transition-colors"></div>
                      {service}
                    </span>
                  </li>
                ))}
          ...
          <div className="border-t border-white/10 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-6">
              ...
              <div className="text-center text-blue-200">
                <p>© {new Date().getFullYear()} Innos. All rights reserved.</p>
              </div>
            </div>
          </div>
        </div>
